...
window.HOTKEY_DRILLS = {
  ...
  // total anywhere else.
  groups: [
    { name: 'Foundations',    keys: ['navigation', 'entrybasics', 'ribbonways', 'filldr', 'pastes', 'blocksel', 'rowops', 'editfix', 'modeltour'] },   /* r367: modeltour moved from #2 to capstone · r424 (D17): colops RETIRED — rowops absorbed it · r457: entrybasics (Enter/Edit/Fill) + ribbonways (Ribbon & Chords) added as onboarding drills #2/#3 — the light guided onramp between the corridor game and the fulsome builds (the navigation→filldr cliff). The lightest-first reorder of the five iterated drills lands with the full curriculum-map restructure. */
