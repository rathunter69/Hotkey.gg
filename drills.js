...
window.HOTKEY_DRILLS = {
  ...
  meta: {
    // Foundations
    navigation: { name:'Navigate', label:'Navigation tour',     tab:'Nav',         desc:'Teleport corner to corner with the Ctrl-arrows, then fill a whole row in one keystroke' },
