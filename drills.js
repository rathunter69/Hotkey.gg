...
window.HOTKEY_DRILLS = {
  ...
  meta: {
    ...
    cases:      { name:'Sticky switch', label:'Sticky IFs \u2014 snapshot each case', tab:'Cases', desc:'Scenario switch drives the model; a self-referencing IF snapshots each case into the output table' },
