...
window.HOTKEY_DRILLS = {
  ...
  meta: {
    ...
    foot:       { name:'Foot',     label:'Total it both ways',  tab:'Cross-foot',  desc:'Totals down and across, the corner agreeing with both edges, check at zero' },
