...
window.HOTKEY_DRILLS = {
  ...
  meta: {
    // Foundations
    navigation: { name:'Navigate', label:'Navigation maze',     tab:'Nav',         desc:'A literal maze of bold walls — shoot down a corridor to the next wall, or step around corners one cell at a time. Collect every pip, then copy the model and paste it at the drop zone' },
    autofit:    { name:'Autofit',  label:'Fix the squeezed columns',tab:'Autofit',  desc:'##### everywhere — autofit the columns to their content' },
    rowops:     { name:'Rows',     label:'Rebuild the schedule',    tab:'Rows',     desc:'Insert a row and paste the staged line, delete the junk, close the schedule with a bottom border \u2014 the Total re-sums itself as rows come and go' },
