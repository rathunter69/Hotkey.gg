...
window.HOTKEY_DRILLS = {
  ...
  meta: {
    // Foundations
    navigation: { name:'Navigate', label:'Navigation tour',     tab:'Nav',         desc:'Teleport with the Ctrl-arrows, then grab a column, a row, and the whole model — each in one chord' },
