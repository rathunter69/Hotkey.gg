...
window.HOTKEY_DRILLS = {
  ...
  meta: {
    ...
    blocksel:   { name:'Block Sel.',label:'Assemble the summary',   tab:'Block',    desc:'COPY the reference that stays, CUT the misfiled columns into the labeled output, then dress it' },
