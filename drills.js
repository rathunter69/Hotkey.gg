...
window.HOTKEY_DRILLS = {
  ...
  meta: {
    // Foundations
    navigation: { name:'Navigate', label:'Navigation tour',     tab:'Nav',         desc:'The keyboard LEAPS every direction — thread a random maze marker to marker, grab the model, copy it, drop it in the deck, land home' },
