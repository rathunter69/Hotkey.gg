...
window.HOTKEY_DRILLS = {
  ...
  // total anywhere else.
  groups: [
    { name: 'Foundations',    keys: ['navigation', 'entrybasics', 'filldr', 'pastes', 'blocksel', 'rowops', 'editfix', 'modeltour'] },   /* r367: modeltour moved from #2 to capstone · r424 (D17): colops RETIRED — rowops absorbed it · r457: entrybasics (Enter/Edit/Fill) added as onboarding drill #2 — a light guided rung between the corridor game and the fulsome builds (the navigation→filldr cliff) */
