...
begin
  ...
  v_keys := case p_track
    ...
    when 'formulas' then array['margin','foot','anchor','percent','cagr','bridge','sumif','rollup','fxconvert','cases','sort','scrub','filterpass','unhide','lookup','lookup2','recon','drill','series','audit','triage','wrapfix','balcheck','stalelink','tieout','hunt','signerr','versionup','balance']
