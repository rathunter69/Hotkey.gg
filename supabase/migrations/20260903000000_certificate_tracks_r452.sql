...
begin
  ...
  v_keys := case p_track
    when 'fluency'  then array['navigation','entrybasics','ribbonways','filldr','pastes','blocksel','rowops','editfix','modeltour','typeset','decimals','center','autofit','ruleoff','ruleaudit','combo','housestyle','gauntlet']
