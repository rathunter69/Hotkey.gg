...
table('TEXT follows Excel format codes: leading zeros, sections, times, scientific, passthrough', [
  ...
  ['=TEXT(1234,"0.00E+00")', '1.23E+03'], ['=TEXT(0.000123,"0.0E-0")', '1.2E-4'], ['=TEXT("abc","0")', 'abc'],
  // an empty format text formats to nothing; date-looking text reads as its serial; every code the cell formatter honours, TEXT honours
  ['=TEXT(5,"")', ''], ['=TEXT(5,F1)', ''], ['=LEN(TEXT(5,""))', 0], ['=TEXT(TRUE,"")', ''], ['=TEXT("1/31/2026","yyyy")', '2026'], ['=TEXT("2026-01-31","mmm-yy")', 'Jan-26'], ['=TEXT("31-Jan-26","yyyy-mm-dd")', '2026-01-31'],
  ['=TEXT("12:00","h AM/PM")', '12 PM'], ['=TEXT("12:00 PM","hh:mm")', '12:00'], ['=TEXT("1/31/2026","mmmm d")', 'January 31'], ['=TEXT(2.5,"0.0x")', '2.5x'], ['=TEXT(1234567,"#,##0,k")', '1,235k'], ['=TEXT(4.34,"# ?/?")', '4 1/3'], ['=TRIM(TEXT(0.34,"# ?/?"))', '1/3'],
  ['=TEXT(45000.5,"h:mm:ss.00")', '12:00:00.00'], ['=TEXT(0.5208333,"h:mm:ss")', '12:30:00'], ['=TEXT(1500500,"#0.0E+0")', '1.5E+6'], ['=TEXT(-5,"0;@")', '-5'], ['=TEXT(5,"[Red]")', '5'], ['=TEXT(1/3,"0.00000000000000000")', '0.33333333333333300'],
  ['=TEXT(1E9,"yyyy")', '#VALUE!'], ['=TEXT(1E9,"mmm")', '#VALUE!'], ['=TEXT(2958466,"d/m/yyyy")', '#VALUE!'], ['=TEXT(1E+307,"0%")', '#VALUE!'], ['=IFERROR(TEXT(1E+307,"0%"),"x")', 'x'], ['=TEXT(5/24,"[hh]:mm")', '05:00'], ['=TEXT(46053,"d-mmm-e")', '31-Jan-2026'], ['=TEXT(E1,"@")', 'apple'], ['=TEXT(B1,"0.00")', '5.00'], ['=TEXT(B3,"0")', 'TRUE'], ['=TEXT(F1,"0")', '0'], ['=TEXT(5,"0 kg")', '#VALUE!'], ['=TEXT(45000,"0 yyyy")', '#VALUE!'], ['=TEXT(-1,"yyyy")', '#VALUE!'], ['=TEXT(5,"\\k\\g0")', 'kg5'], ['=TEXT(12345.678,"$#,##0.00_);($#,##0.00)")', '$12,345.68 '], ['=TEXT(-12345.678,"$#,##0.00_);($#,##0.00)")', '($12,345.68)'],
...
table('dates are serial numbers', [
  ...
  // the weekday follows the serial: Excel's phantom 29 Feb 1900 puts Jan–Feb 1900 a day off the real calendar (1-Jan-1900 is a Sunday)
  ['=WEEKDAY(1)', 1], ['=WEEKDAY(59)', 3], ['=WEEKDAY(60)', 4], ['=WEEKDAY(61)', 5], ['=WEEKDAY(0)', 7], ['=WEEKDAY(1,2)', 7], ['=TEXT(1,"dddd")', 'Sunday'], ['=TEXT(DATE(1900,2,28),"ddd")', 'Tue'],
