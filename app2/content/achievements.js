...
export const ACHIEVEMENTS = [
  ...
  { id: 'sec-welcome', glyph: 'flag', rarity: 'common', name: 'Through the Door', desc: 'Finish the Welcome', test: c => sectionDone(c, 'Welcome') },
  { id: 'sec-how', glyph: 'book', rarity: 'common', name: 'Under the Hood', desc: 'Finish How Excel works', test: c => sectionDone(c, 'How Excel works') },
  { id: 'sec-moving', glyph: 'arrows', rarity: 'common', name: 'Navigator', desc: 'Finish Moving', test: c => sectionDone(c, 'Moving') },
  { id: 'sec-selecting', glyph: 'select', rarity: 'common', name: 'Selector', desc: 'Finish Selecting', test: c => sectionDone(c, 'Selecting') },
  { id: 'sec-editing', glyph: 'pencil', rarity: 'common', name: 'Editor', desc: 'Finish Entering and editing', test: c => sectionDone(c, 'Entering and editing') },
  { id: 'sec-rows', glyph: 'rows', rarity: 'common', name: 'Structural', desc: 'Finish Rows, columns and sheets', test: c => sectionDone(c, 'Rows, columns and sheets') },
  { id: 'sec-ribbon', glyph: 'ribbon', rarity: 'common', name: 'Ribboneer', desc: 'Finish The Ribbon and dialogs', test: c => sectionDone(c, 'The Ribbon and dialogs') },
  { id: 'sec-formulas', glyph: 'sigma', rarity: 'common', name: 'Calculator', desc: 'Finish Basic formulas', test: c => sectionDone(c, 'Basic formulas') },
  { id: 'sec-clipboard', glyph: 'clipboard', rarity: 'common', name: 'Quartermaster', desc: 'Finish Copy, paste and fill', test: c => sectionDone(c, 'Copy, paste and fill') },
  { id: 'ch1-project', glyph: 'grid', rarity: 'rare', name: 'Report Builder', desc: 'Complete the weekly report project', test: c => count(P(c)['weekly-report-project'] && P(c)['weekly-report-project'].completed ? 1 : 0, 1) },
