...
export const COPY = {
 ...
 "site": {
  ...
  "tab_keys_note": "Your browser may keep Ctrl+PgDn and Ctrl+PgUp for its own tabs. Fullscreen hands them to the sheet, and so does the installed app.",
  "due_fresh": "Nothing here yet. Shortcuts you learn come back here the next day as thirty-second refreshers.",
  "archive_line": "Earlier versions of these lessons, kept playable. The modules above are the chapter."
 },
 "micro": {
  "enter-tab-direction": {
