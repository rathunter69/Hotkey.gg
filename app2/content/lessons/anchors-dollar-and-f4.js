...
export default {
  ...
  goals: [
    ...
    { id: 'fill-right', text: 'Give J5 thousands separators, no decimals, then fill it right across J5:L5 with Ctrl+R: $C5 stays on the kWh column, the price moves.', keys: '↑ Ctrl+Shift+1 then Alt H 9 Alt H 9 then Shift+→ ×2 Ctrl+R', requires: ['fill-down-right', 'relative-absolute', 'number-formats', 'shift-arrow', 'arrow-keys'],
    ...
    { id: 'clear-stub', text: 'The old sensitivity stub under the daily block, a half-built what-if table, is covered by the grid now: select A23:F24 and clear it.', keys: 'Ctrl+← Ctrl+↓ ×4 ↓ Ctrl+Shift+→ Shift+↑ Delete', requires: ['delete-clears', 'ctrl-arrow', 'ctrl-shift-arrow', 'shift-arrow', 'arrow-keys'],
