...
export default {
  ...
  solution: 'Ctrl+Home Ctrl+Down Ctrl+Down Down Ctrl+Right Right "=" Left Left "-" Left Enter Up Right "=" Left Left Left "/" Ctrl+Left Ctrl+Left Right Right Enter Up Right "=" Left Left "/" Ctrl+Left Ctrl+Left Right Right Right Enter Up Left Left F2 Escape Shift+Right Shift+Right Shift+Down Shift+Down Shift+Down Shift+Down Shift+Down Ctrl+D Down Ctrl+Shift+Down Ctrl+1 N',
};
