...
export default {
  ...
  goals: [
    ...
    { id: 'units-italic', text: 'The units line USD unless stated in A2 is a note, not a figure: make it italic with Ctrl+I so it reads as one.', keys: 'Ctrl+Home ↓ Ctrl+I', requires: ['bold-italic-underline', 'ctrl-home-end'],
  ...
  solution: 'Ctrl+Home Down Down Down Ctrl+Right Up Up Up Ctrl+Shift+Left Ctrl+1 A Ctrl+Home Ctrl+Shift+Right Ctrl+Down Ctrl+Down Right Right Ctrl+Shift+Right Alt H A R Ctrl+Home Down Ctrl+I Ctrl+Down Ctrl+Down Ctrl+Down Down Ctrl+Shift+Down Alt H 6 Ctrl+PgDn Ctrl+PgDn Ctrl+Down Up Up Ctrl+Right Alt H W',
};
