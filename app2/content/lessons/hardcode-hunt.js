...
export default {
  ...
  goals: [
    { id: 'find-constants', teach: 'The audit pass is three looks: Go To Special for typed numbers among links, show formulas for a number in a formula row, the page for the rest.', text: 'Typed numbers hide among the links: select C5:E10, run Go To Special for Constants, and color Cedar Park’s emailed figures blue.', keys: 'Ctrl+↓ ↓ → ×2 Ctrl+Shift+↓ Shift+↑ Shift+→ ×2 then Alt H F D S O ↵ then Alt H F C → ×4 ↵', requires: ['audit-pass', 'go-to-special', 'font-color', 'input-colour-convention', 'ctrl-arrow', 'ctrl-shift-arrow', 'shift-arrow', 'keytips', 'arrow-keys'], convention: 'F3',
    ...
    { id: 'refill-thursday', text: 'In the daily table Mueller’s Thursday E18 is a number in a formula row: select B18:G18, F2 on the link in G18, Ctrl+Enter, Ctrl+` off.', keys: 'Ctrl+↓ ×3 ↑ ×3 Ctrl+Shift+← Shift+→ F2 Ctrl+↵ then Ctrl+`', requires: ['show-formulas', 'ctrl-enter-fill', 'edit-mode-f2', 'ctrl-arrow', 'ctrl-shift-arrow', 'arrow-keys'],
  ...
  solution: `Ctrl+Down Down Right Right Ctrl+Shift+Down Shift+Up Shift+Right Shift+Right Alt H F D S O Enter Alt H F C Right Right Right Right Enter Right Right F4 Ctrl+\` Ctrl+Right Left Ctrl+Up Down Down "=" Left Left Left "/" Ctrl+Left Right Right Enter Ctrl+Down Ctrl+Down Ctrl+Down Up Up Up Ctrl+Shift+Left Shift+Right F2 Ctrl+Enter Ctrl+\` Ctrl+Home Down Down Down Ctrl+Right Left Left Left Ctrl+Space Shift+Right Ctrl+Shift+) Ctrl+Home Ctrl+Left Ctrl+Up Ctrl+Up "${REPORT_TITLE}" Enter Down Down Ctrl+Right Left Left Left Ctrl+Up Ctrl+Shift+Left Ctrl+1 A Ctrl+Left Down Ctrl+I "USD unless stated" Enter Ctrl+Down Ctrl+Down Ctrl+Down Down Down Right Ctrl+Shift+Down Ctrl+Shift+Right Alt H B N Alt W V G`,
};
