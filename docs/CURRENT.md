...
| **Plan UI/UX onboarding flows**, `01a0b908-48f9-7f32-94b2-d0ca46f13de3`; `codex/experience-site-plan` from accepted 16ee830 | Latest handoff 965bdb9 remote-verified. Six presentation choices approved: Help panel, Challenges link, expandable outcome checklist, ordinary result panel, secondary guest save invitation/Home reminder and Lesson options menu. Existing aesthetic preferred; catalog path/chapter-next-step preference remains tentative. | Owns only `docs/handoffs/experience-site.md`. Historical grid review and 12 isolated layout measurements recorded; all-visible-row usability and small-window fallback questions pending. Coordinate Catalog/Engine effects before implementation. Other exact layouts/copy unapproved; no full playtest or app change. |
...
| Catalog/flow decision review | [c08b53b](https://github.com/rathunter69/Hotkey.gg/blob/c08b53b73afcfd3cb5e660b8a9f3d232c028f83e/docs/handoffs/catalog-progression.md) | Chief verified remote file and sole-doc delta from 194db93. All 15de791 approvals retained. Bounded review of UI b0d2f17 found no material conflict or new learner state; no full layout approval or runtime validation. Ownership remains Catalog semantics, UI presentation, Storage persistence/comparison. |
| UI/UX planning | [965bdb9](https://github.com/rathunter69/Hotkey.gg/blob/965bdb9c74e36fd93d8a80845669a3f0cea3a6b5/docs/handoffs/experience-site.md) | Chief verified branch tip/file and handoff-only follow-ups 7799ed5 → 37ee64f → 965bdb9. Six explicit user answers read and reconciled in PRODUCT; tentative catalog preference preserved. Historical grid evidence and bounded 3-drill × 4-window diagnostic reported separately from reused passing grid/resize suites. Two grid questions pending; not full accessibility/platform/playtest clearance. |
| Saved-progress planning | [e9f3e6e](https://github.com/rathunter69/Hotkey.gg/blob/e9f3e6e06b84378b57ec03534920ba9bb01f8ee4/docs/handoffs/leaderboards-storage.md) | Chief verified branch tip, file identity and two-commit ancestry from 16ee830: only leaderboards-storage handoff added. Catalog's sole wording clarification preserves known imported completion separately from proposed new XP/readiness/PB eligibility. UI alignment and independent contract review recorded; no Security approval or working-save claim. |
...
PRODUCT records those principles. Exact duration, timing/proof, failure/import mechanics and
legacy mappings remain open. The chief directly verified six UI choices and recorded them in
PRODUCT: side-panel Help, small Challenges link, short outcome guidance with expandable checklist,
ordinary results beside the completed sheet, secondary guest save invitation/Home reminder and
one Lesson options menu with Help/mute visible. These questions are answered. The path/chapter
...
reused, not rerun. No blanket usability or future worksheet-scrolling claim follows.
Two questions remain in the UI task: all visible rows usable, and readable scrolling/fullscreen
fallback versus a minimum-window gate. Do not duplicate that questionnaire. Catalog/Engine must
review boundary/grading/history effects before any implementation; exact layouts remain open.
