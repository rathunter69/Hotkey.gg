...
| **Audit catalog and learner flow**, `01a0b148-2693-7901-af91-934c83cabe1d`; `codex/catalog-flow-review` from preserved 00df57a | 349da10 verified against Wolf's two explicit answers: short lesson before signup, then personalization/save invitation with experienced shortcut; useful free beginner path with its replay/speedruns and selected advanced previews; advanced learning/model-building paid. Retains approved simpler structure at b26f112 and retired reward questionnaire. | Owns only `docs/handoffs/catalog-progression.md`; next make completion/save/next-step journey concrete. Exact content/preview rules, prices, guest transfer/save, XP, comparison/competition/access and historical-rank details remain open. Preserve history; no implementation or new module authorized. |
...
| Catalog/flow decision review | [349da10](https://github.com/rathunter69/Hotkey.gg/blob/349da102daa592cbe8f15a0bd3e74923ebcab374/docs/handoffs/catalog-progression.md) | Chief verified sole-doc delta from b26f112 and Wolf's explicit lesson-first/useful-free-path approvals. Retains simpler progression, preserved earned progress/rank and open XP formulas. Exact content/access/save rules remain open; no source re-audit, implementation or new modules. |
...
Next: make the completion/save/next-step journey concrete in a manageable group of choices.
...
without duplicating questions; retain all approved entry/access/readiness/help/timer/simpler-
progression rules and qualified D1/D2 support. No implementation or new module is authorized;
