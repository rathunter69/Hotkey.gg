...
**Gate 2 proposal delivered:** the chief verified the [Foundations opening at bba4bb4](https://github.com/rathunter69/Hotkey.gg/blob/bba4bb41733833d4ea96a44b614275e6d1826e7d/docs/handoffs/drill-catalog.md#september-21--compact-foundations-opening-specification).
Four short taught units cover active cell/selection, Home/Font/Bold, opening/closing Fill Color,
and applying a Column Width dialog setting; an optional fresh report applies the learned skills.
Each specifies prerequisites, known starting state, named actions, observable outcomes, valid
routes, teaching-versus-solution-help and fresh solo behavior. O1–O5 are planning labels, not
approved production IDs or five mandatory lessons; O1/O2 may combine. Exact control/width/
platform behavior requires UI/Engine verification, and Storage must resolve lesson/attempt
identity and credit without duplication. Normal explanations do not automatically mark help.
The sequence works under either pending Foundations grouping and precedes the earlier copying
blueprint; it adds no new Intro mode. The owner reports focused independent review; the chief
verified the sole-file commit, matching blob/tip and unchanged 74-ID crosswalk/four earlier
blueprints. No application tests or runtime changes. The proposal now awaits review, not a push.
C1/C2/C3, exact packaging and memberships remain pending. Other rows are staged planning
dependencies, not automatic starts or newly assigned application work. Shared guidance remains
chief-owned.
...
application change was identified by this remote/task status review. The new Catalog opening
plan has now been pushed and verified at bba4bb4; it awaits product/dependency review.
Private task exports, transfer ZIP and local
...
## Curriculum-planning workstream — overview updated September 21
...
| **Audit catalog and learner flow**, `01a0b148-2693-7901-af91-934c83cabe1d`; `codex/catalog-flow-review` | Detailed opening bba4bb4 remote-verified: four taught interface/ribbon units plus optional fresh application, with named goals/help/solo/dependency rules. Prior 74-ID crosswalk and four blueprints unchanged. | Owns `docs/handoffs/drill-catalog.md`; systems provenance stays in `catalog-progression.md`. Opening, C1/C2/C3 hierarchy/Foundations/project choices and exact memberships await review; control/platform support is unverified. Optional packs/inclusion/version display remain proposals. No runtime change or rebuild. |
...
| Curriculum roadmap and expansion overview | [1ddd1b8](https://github.com/rathunter69/Hotkey.gg/blob/1ddd1b88a8ae4dcfe35314001816ff109a28435a/docs/handoffs/drill-catalog.md#september-20--curriculum-overview-and-future-content-modules) | Chief verified file/blob and then-current Catalog branch tip; sole-handoff update from 71cc00e. Initial 74-ID inventory/four blueprints retained; area reports unchanged crosswalk and focused independent expansion review. Extensibility is confirmed, while chapters, candidate packs, inclusion/pricing and version-display rules remain proposed. No repeated audit, application tests or implementation. |
| Detailed Foundations opening proposal | [bba4bb4](https://github.com/rathunter69/Hotkey.gg/blob/bba4bb41733833d4ea96a44b614275e6d1826e7d/docs/handoffs/drill-catalog.md#september-21--compact-foundations-opening-specification) | Chief verified the branch tip, blob 1b9cdcb and sole handoff change from 1ddd1b8; prior crosswalk/four blueprints match. Proposed O1–O4 teach selection/ribbon/menu/dialog, optional O5 applies learned outcomes. Independent review is reported by owner. Exact packaging/control support/structure/access remain pending; no app tests or implementation. |
...
| Payments/subscription planning | [ab68edc](https://github.com/rathunter69/Hotkey.gg/blob/ab68edc09e2d5c6a85b3c31bce3b2ff16b998971/docs/handoffs/payments.md) | Chief verified remote file/blob and sole-handoff update from 00de01d. P1–P10 are now confirmed and reconciled, including prices/trial/expiry/cancellation/guarantee/group access. Student verification, invitation controls and lifecycle exceptions remain open. Source scaffold findings at 16ee830 remain; no live audit, app/payment tests or activation. |
