...
- **PENDING — live smoke test**: desks/school-tags/assignments RPCs + 8 seeded desk
  ...
  run the smoke test (sign in, create/join/leave desk, claim a seeded desk,
